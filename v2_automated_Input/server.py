...
def process_job(company, job_title, location, job_link):
    ...
    destination_path = job_folder / "Yashodhar Hajare_Anschreiben.docx"
    ...
    for paragraph in doc.paragraphs:
        ...
        for run in paragraph.runs:
            if any(keyword in run.text for keyword in [company, job_title, location, today_date]):
